...
public class myProducts extends HttpServlet {
 ItemDataAccess acess = new ItemDataAccess();
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Item> myProducts = new ArrayList<>(); 
        ...
        //get all product from db which belongs to current user
        myProducts = acess.getAllProducts(user);
